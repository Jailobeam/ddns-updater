...
// ExtractProvidersFromBytes validates and extracts providers from raw JSON.
func ExtractProvidersFromBytes(jsonBytes []byte) (
	allProviders []provider.Provider, warnings []string, err error,
) {
	return extractAllSettings(jsonBytes)
}
