...
> This fork keeps the original upstream project structure and adds an integrated admin UI for browser-based DDNS entry management.

<img height="200" alt="DDNS Updater logo" src="https://raw.githubusercontent.com/qdm12/ddns-updater/master/readme/ddnsgopher.svg">

## Features

- Fork additions in this repository:
  - Integrated admin UI to add, edit, delete, activate and deactivate DDNS entries directly from the browser
  - Provider-aware configuration forms generated from the embedded upstream provider documentation
  - Combined overview for entries, live status and actions
...
- Anonymized preview of the custom admin UI in this fork

    ![Anonymized custom admin UI](readme/ui-preview-anonymized.png)
...
- Original project and DDNS provider engine: [Quentin McGaw](https://github.com/qdm12)
- UI rework and fork customization: [Jailobeam](https://github.com/Jailobeam)
